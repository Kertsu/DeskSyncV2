...
import { confirmationGuard, dashboardGuard, deskAreaGuard, navigationGuard, onboardingGuard, passwordResetGuard, passwordResetSuccessGuard, resetPasswordGuard } from './shared/navigation.guard';
...
const routes: Routes = [
  ...
  {
    path: 'reset-password/:token/:id', component: ResetPasswordComponent, canActivate: [authGuard, resetPasswordGuard]
  },
  {
    path: 'forgot-password', component: ForgotPasswordComponent, canActivate: [authGuard]
  },
  {
    path: 'check-email', component: CheckEmailComponent, canActivate: [authGuard, passwordResetGuard]
  },
  {
  ...
  {
    path: 'hdbsv2',
    canActivate: [guestGuard, dashboardGuard],
